  ...
  const actions: Action[] = [
    {
      ...
      onPress: () => router.replace('/add-transaction?type=expense'),
    },
    {
      label: 'Add Income',
      sub: 'Money coming in',
      ...
      onPress: () => router.replace('/add-transaction?type=income'),
    },
    {
      label: 'Add Transfer',
      ...
      onPress: () => router.replace('/add-transaction?type=transfer'),
    },
    {
      label: 'Loans & Friends',
